...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      ...
      // Auth
      authCookieName: process.env.NUXT_PUBLIC_AUTH_COOKIE_NAME || 'warungai_token',
      authCookieExpires: parseInt(process.env.NUXT_PUBLIC_AUTH_COOKIE_EXPIRES || '7'),
      ...
      // Upload
      maxUploadSize: parseInt(process.env.NUXT_PUBLIC_MAX_UPLOAD_SIZE || '5242880'),
      allowedFileTypes: process.env.NUXT_PUBLIC_ALLOWED_FILE_TYPES || 'image/jpeg,image/png,image/webp',
      
      // Pagination
      defaultPageSize: parseInt(process.env.NUXT_PUBLIC_DEFAULT_PAGE_SIZE || '10'),
  ...
  app: {
    head: {
      ...
      meta: [
        { name: 'description', content: process.env.NUXT_PUBLIC_APP_DESCRIPTION || 'Platform AI untuk UMKM Indonesia' },
