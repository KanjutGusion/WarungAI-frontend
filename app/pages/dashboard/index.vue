    ...
    <main class="flex-1 px-4 py-6 sm:px-6 lg:px-10 lg:pl-10">
      <div class="w-full space-y-10">
        ...
        <header class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-5 justify-between mt-4">
            <!-- Label Tanggal -->
            <span
            ...
            <button
              @click="exportPdf()"
              class="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg border border-purple-500 text-purple-600 dark:text-purple-300 bg-white dark:bg-slate-900 hover:bg-purple-50 dark:hover:bg-slate-800 transition"
            >
              <svg
